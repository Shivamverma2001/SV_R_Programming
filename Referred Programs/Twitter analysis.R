...
library(tidytext)
appname <- "r__1234"
key <- "7P9eCDHNAfEjXbJuObH0ygECn"
secret <- "tqSDPF4PzidefpVNG6THC0AQZoXv6pRkAvL3P7iGpj4lzI0jBL"
access<-"1510876401922351104-Hxjddiz3dAQ6KqRQcvZ92URSC9r2Ge"
access_secret="f6ylMSKgHEiWiMapaF5t7sSxfE5NBPHQDcm3C4LJW4MhE"
...
Sentimentscores_tech<-cbind("sentiment"=rownames(Sentimentscores_tech),
