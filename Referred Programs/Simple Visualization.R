...
cars <- c(1, 3, 6, 4, 9)
cars
# Graph the cars vector with all defaults 1,2,3,4,5
...
g_range
# Graph autos using y axis that ranges from
#0 to max value in cars or trucks vector.  Turn
#off axes and annotations (axis labels) so we 
#can specify them ourselves 
